    ...
    win.OPPY.page = (function () {
        return {
            ...
            pageReposition : function () {
                for (var i = 0, max = win.OPPY.Common.Pageobj.length; i < max; i++) {
                    win.OPPY.Common.Pageobj[i].reInit();
                }
            },
