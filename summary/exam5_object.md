...
반면 on은 이벤트 핸들러를 통한 처리를 계속한다.
+ 또한 bind() jquery 1.7 이후부터 on 매소드 사용을 권장하고 있으며,<br>
on이 나오면서 새로운 기능적용이 안될 예정이며 사라질 수도 있기 때문이다.


출처: http://hohoya33.tistory.com/entry/bindonlivedelegate-메소드의-사용-정리 [Front-end posting]
