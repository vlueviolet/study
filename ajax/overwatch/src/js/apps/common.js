(function (win, $, doc) {
    ...
    win.OVERWATCH.page = (function () {
        return {
            ...
            bindEvents : function () {
                $('body').on('page.reposition', $.proxy(this.pageReposition, this));
            },
            pageReposition : function () {
                for (var i = 0, max = win.OVERWATCH.Common.Pageobj.length; i < max; i++) {
                    win.OVERWATCH.Common.Pageobj[i].reInit();
                }
            },
