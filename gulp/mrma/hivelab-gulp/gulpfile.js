...
gulp.task('initialize', function () {
    runSequence('clean-dist-folders', 'images-deploy', 'inline-svg', 'css-libs-deploy', 'generate-sass-sprites', 'minify-js', 'root-files-deploy', 'font-files-deploy', 'clean-libs-folder', 'html', 'watch', 'server', () => {
